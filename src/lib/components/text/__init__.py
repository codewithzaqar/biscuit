...
class Text(tk.Text):
    ...
    def show_unsupported_dialog(self):
        ...
        self.data = "This file is not displayed in this editor because it is either binary or uses an unsupported text encoding. Do you want to open it anyway? None"
        self.clear_insert()
